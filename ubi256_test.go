...
func TestSkein(t *testing.T) {
	...
	Convey("skein256_128 matches skein256_N", t, func() {
		for _, msg := range sampleMessages {
			h := Skein256_128(msg)
			So(h[:], ShouldResemble, Skein256_N(msg, 128))
		}
	})
	...
	Convey("skein256_512", t, func() {
		Convey("matches skein256_N", func() {
			for _, msg := range sampleMessages {
				h := Skein256_512(msg)
				So(h[:], ShouldResemble, Skein256_N(msg, 512))
			}
		})
		Convey("passes test vectors", func() {
			So(Skein256_N(make([]byte, 128), 512), ShouldResemble, []byte{
	...
	Convey("skein256_1024", t, func() {
		Convey("matches skein256_N", func() {
			for _, msg := range sampleMessages {
				h := Skein256_1024(msg)
				So(h[:], ShouldResemble, Skein256_N(msg, 1024))
			}
		})
		Convey("passes test vectors", func() {
			So(Skein256_N(make([]byte, 128), 1024), ShouldResemble, []byte{
