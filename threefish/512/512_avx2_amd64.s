...
TEXT   ·threefish512_avx2(SB), $-4-24
	MOVQ	state+0(FP), R10
	CALL ·transpose4x8(SB)
	...
	CALL ·transpose4x8(SB)
	VMOVNTDQA	0(R10), Y9
	VMOVNTDQA	32(R10), Y13
	VPXOR		Y13, Y9, Y9
	VMOVNTDQA	64(R10), Y13
	VPXOR		Y13, Y9, Y9
	VMOVNTDQA	96(R10), Y13
	VPXOR		Y13, Y9, Y9
	VMOVNTDQA	128(R10), Y13
	VPXOR		Y13, Y9, Y9
	VMOVNTDQA	160(R10), Y13
	VPXOR		Y13, Y9, Y9
	VMOVNTDQA	192(R10), Y13
	VPXOR		Y13, Y9, Y9
	VMOVNTDQA	224(R10), Y13
	VPXOR		Y13, Y9, Y9
	VMOVNTDQA	c240<>(SB), Y13
	VPXOR		Y13, Y9, Y9		// Y9 now has the extnded key.
...
// func transpose4x8()
TEXT   ·transpose4x8(SB), $0
	// Transpose state data in place, expecting relevant pointer to be in R10
	MOVQ 8(R10), R8
	MOVQ 64(R10), R9
	MOVQ R9, 8(R10)
	MOVQ R8, 64(R10)
